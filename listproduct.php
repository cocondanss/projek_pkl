...
<body>
    ...
    console.log('ID:', id, 'Name:', name, 'Price:', price, 'Discount:', discount); // Log untuk debugging
    ...
    // Jika ada diskon, Anda dapat menampilkan informasi diskon di modal
    if (discount > 0) {
        document.getElementById('modal-discount').innerText = 'Diskon: Rp ' + discount;
    }
